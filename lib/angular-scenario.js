...
angular.scenario.dsl('element', function() {
  ...
  var isHrefVoid = function(href) {
    href = href.toLowerCase();
    href.replace(/\s+/g, ' ');
    if (href.substring(0, 18) == "javascript:void(0)") {
      return true;
    } else {
      return false;
    }
  ...
  var isHrefAnchor = function(href) {
    href.replace(/\s+/g, ' ');
  ...
  chain.click = function() {
    return this.addFutureAction("element '" + this.label + "' click", function($window, $document, done) {
      ...
      if (href && !isHrefVoid(href) && !isHrefAnchor(href) && elements[0].nodeName.toUpperCase() === 'A' && eventProcessDefault) {
